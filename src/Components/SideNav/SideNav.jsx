          ...
          <div className={styles.menuContainer}>
           ...
           <div className={styles.linkContainer}>
                  ...
                  <Collapse isOpen={isOpenContent}>
                    ...
                    <Collapse isOpen={isOpenServices}>
                      ...
                      <Link to="/services-view">
                          <p>Services<small>(View Create)</small></p>
                        </Link>
                      ...
                      <Collapse isOpen={isOpenCity}>
                        ...
                        <Link to="/city-to-city-transfer-view">
                          <p>City to City Transfer<small>(View Create)</small></p>
                        </Link>
                      ...
                      <Collapse isOpen={isOpenEvents}>
                        ...
                        <Link to="/events">
                          <p>Events<small>(View Create)</small></p>
                        </Link>
                      ...
                      <Collapse isOpen={isOpenCelebration}>
                        ...
                        <Link to="/celebration">
                          <p>Celebration<small>(View Create)</small></p>
                        </Link>
             ...
             {menu && menu.map((data)=>{
              return(
                (data == "staffmembers" ?
                <Link to="/staff-members" className={styleHandler("/staff-members")}>
                <div className={styles.iconContainer}>
                  <Dashboard className={styles.icon} width="100%" />
                </div>
                <div className={styles.linkContainer}>
