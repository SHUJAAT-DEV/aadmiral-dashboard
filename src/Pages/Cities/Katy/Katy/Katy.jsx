...
import styles from "./Katy.module.scss";
import { useDispatch, useSelector } from "react-redux";
import {
  getKatyCarService,
  updateKatyCarService,
} from "../../../../redux/ContentManagement/katyCarService/action";
...
const Katy = () => {
  ...
  const {
    ...
    updated,
    error,
  } = useSelector((state) => state.katyCarService);

  useEffect(() => {
    dispatch(getKatyCarService());
  }, [loading]);
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.katyLimoService[0]._id);
    ...
    dispatch(updateKatyCarService(formData));
  };
