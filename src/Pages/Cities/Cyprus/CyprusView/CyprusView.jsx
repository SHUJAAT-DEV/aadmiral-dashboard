...
import styles from "./CyprusView.module.scss";
import { Link } from "react-router-dom";
import longCar from "../../../../Assets/GalvestonView/Image 19.png";
import { useDispatch, useSelector } from "react-redux";
import { getCyprusCarService } from "../../../../redux/ContentManagement/cyprusCarService/action";
    ...
    <div className={styles.dashboard_container}>
      <section className="app-content-wrapper">
        <div className={styles.dashboard_content_container}>
          <h2>Cypress</h2>
          {modifiedResponse ? (
            modifiedResponse.cypressLimoService.map((item) => (
