...
import styles from "./Cyprus.module.scss";
import { useDispatch, useSelector } from "react-redux";
import {
  getCyprusCarService,
  updateCyprusCarService,
} from "../../../../redux/ContentManagement/cyprusCarService/action";
...
const Cyprus = () => {
  ...
  const {
    ...
    updated,
    error,
  } = useSelector((state) => state.cyprusCarService);

  useEffect(() => {
    dispatch(getCyprusCarService());
  }, [loading]);
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.cypressLimoService[0]._id);
    ...
    dispatch(updateCyprusCarService(formData));
  };
