...
import styles from "./Tomball.module.scss";
import { useDispatch, useSelector } from "react-redux";
import {
  getTombaliCarService,
  updateTombaliCarService,
} from "../../../../redux/ContentManagement/tombaliCarService/action";
...
const Tomball = () => {
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.tomballLimoService[0]._id);
    ...
    dispatch(updateTombaliCarService(formData));
  };
