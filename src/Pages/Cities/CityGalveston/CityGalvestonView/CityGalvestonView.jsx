...
import styles from "./CityGalvestonView.module.scss";
import { Link } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import { getGalvestonCarService } from "../../../../redux/ContentManagement/galvestonCarService/action";
import Loader from "../../../../Components/Loader/Loader";
import { Alert } from "reactstrap";

const CityGalvestonView = () => {
    ...
    <div className={styles.dashboard_container}>
      <section className="app-content-wrapper">
        <div className={styles.dashboard_content_container}>
          <h2>Galveston</h2>
          {modifiedResponse ? (
            modifiedResponse.galvestonLimoService.map((item) => (
...
export default CityGalvestonView;
