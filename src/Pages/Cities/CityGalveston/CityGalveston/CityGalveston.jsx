...
import styles from "./CityGalveston.module.scss";
import { useDispatch, useSelector } from "react-redux";
import {
  getGalvestonCarService,
  updateGalvestonCarService,
} from "../../../../redux/ContentManagement/galvestonCarService/action";
...
const CityGalveston = () => {
  ...
  const {
    ...
    updated,
    error,
  } = useSelector((state) => state.galvestonCarService);

  useEffect(() => {
    dispatch(getGalvestonCarService());
  }, [loading]);
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.galvestonLimoService[0]._id);
    ...
    dispatch(updateGalvestonCarService(formData));
  };
