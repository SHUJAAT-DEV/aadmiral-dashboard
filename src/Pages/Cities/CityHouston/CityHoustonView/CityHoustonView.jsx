...
import styles from "./CityHoustonView.module.scss";
import { Link } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import { getHoustonCarService } from "../../../../redux/ContentManagement/houstonCarService/action";
import Loader from "../../../../Components/Loader/Loader";
import { Alert } from "reactstrap";

const CityHoustonView = () => {
    ...
    <div className={styles.dashboard_container}>
      <section className="app-content-wrapper">
        <div className={styles.dashboard_content_container}>
          <h2>Houston</h2>
          {modifiedResponse ? (
            modifiedResponse.houstanLimoService.map((item) => (
...
export default CityHoustonView;
