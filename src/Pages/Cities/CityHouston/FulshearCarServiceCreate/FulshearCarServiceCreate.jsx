...
import styles from "./FulshearCarServiceCreate.module.scss";
import { useDispatch, useSelector } from "react-redux";
import {
  getFulshearCarService,
  updateFulshearCarService,
} from "../../../../redux/ContentManagement/fulshearCarService/action";
import Loader from "../../../../Components/Loader/Loader";
import { Alert } from "reactstrap";

const FulshearCarServiceCreate = () => {
  ...
  const {
    ...
    updated,
    error,
  } = useSelector((state) => state.fulshearCarService);

  useEffect(() => {
    dispatch(getFulshearCarService());
  }, [loading]);
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.fulshearCarService[0]._id);
    ...
    dispatch(updateFulshearCarService(formData));
  };
...
export default FulshearCarServiceCreate;
