...
import styles from "./SpringCarService.module.scss";
import { Link } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import { getSpringCarService } from "../../../../redux/ContentManagement/springCarService/action";
    ...
    <div className={styles.dashboard_container}>
      <section className="app-content-wrapper">
        <div className={styles.dashboard_content_container}>
          <h2>Spring Limo Service</h2>
          {modifiedResponse ? (
            modifiedResponse.springCarService.map((item) => (
              <Card className={styles.table_card}>
                <CardBody className={styles.table_card_body}>
                  ...
                  <div className={styles.bottomButton}>
                    <Link to="/spring-car-service-create">
