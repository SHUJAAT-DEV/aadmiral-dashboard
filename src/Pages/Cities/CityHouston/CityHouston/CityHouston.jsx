...
import styles from "./CityHouston.module.scss";
import { useDispatch, useSelector } from "react-redux";
import {
  getHoustonCarService,
  updateHoustonCarService,
} from "../../../../redux/ContentManagement/houstonCarService/action";
...
const CityHouston = () => {
  ...
  const {
    ...
    updated,
    error,
  } = useSelector((state) => state.houstonCarService);

  useEffect(() => {
    dispatch(getHoustonCarService());
  }, [loading]);
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.houstanLimoService[0]._id);
    ...
    dispatch(updateHoustonCarService(formData));
  };
