...
import styles from "./SpringCarServiceCreate.module.scss";
import { useDispatch, useSelector } from "react-redux";
import {
  getSpringCarService,
  updateSpringCarService,
} from "../../../../redux/ContentManagement/springCarService/action";
import Loader from "../../../../Components/Loader/Loader";
import { Alert } from "reactstrap";

const SpringCarServiceCreate = () => {
  ...
  const {
    ...
    updated,
    error,
  } = useSelector((state) => state.springCarService);

  useEffect(() => {
    dispatch(getSpringCarService());
  }, [loading]);
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.springCarService[0]._id);
    ...
    dispatch(updateSpringCarService(formData));
  };
...
export default SpringCarServiceCreate;
