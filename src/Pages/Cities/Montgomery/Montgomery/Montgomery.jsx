...
import styles from "./Montgomery.module.scss";
import { Link } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import {
  getMontgomeryCarService,
  updateMontgomeryCarService,
} from "../../../../redux/ContentManagement/montgomeryCarService/action";
...
const Montgomery = () => {
  ...
  const {
    ...
    updated,
    error,
  } = useSelector((state) => state.montgomeryCarService);

  useEffect(() => {
    dispatch(getMontgomeryCarService());
  }, [loading]);
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.montgomaryLimoService[0]._id);
    ...
    dispatch(updateMontgomeryCarService(formData));
  };
