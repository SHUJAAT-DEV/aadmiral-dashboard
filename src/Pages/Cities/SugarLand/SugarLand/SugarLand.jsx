...
import styles from "./SugarLand.module.scss";
import { useDispatch, useSelector } from "react-redux";
import {
  getSugarlandCarService,
  updateSugarlandCarService,
} from "../../../../redux/ContentManagement/sugarlandCarService/action";
...
const SugarLand = () => {
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.sugarlandLimoService[0]._id);
    ...
    dispatch(updateSugarlandCarService(formData));
  };
