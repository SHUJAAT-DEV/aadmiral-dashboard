...
import styles from "./Conroe.module.scss";
import { useDispatch, useSelector } from "react-redux";
import {
  getConroeCarService,
  updateConroeCarService,
} from "../../../../redux/ContentManagement/conroeCarService/action";
...
const Conroe = () => {
  ...
  const {
    ...
    updated,
    error,
  } = useSelector((state) => state.conroeCarService);

  useEffect(() => {
    dispatch(getConroeCarService());
  }, [loading]);
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.conroeLimoService[0]._id);
    ...
    dispatch(updateConroeCarService(formData));
  };
