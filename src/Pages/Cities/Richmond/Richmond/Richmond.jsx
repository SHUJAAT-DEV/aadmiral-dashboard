...
import styles from "./Richmond.module.scss";
import { useDispatch, useSelector } from "react-redux";
import {
  getRichmondCarService,
  updateRichmondCarService,
} from "../../../../redux/ContentManagement/richmondCarService/action";
...
const Richmond = () => {
  ...
  const {
    ...
    updated,
    error,
  } = useSelector((state) => state.richmondCarService);

  useEffect(() => {
    dispatch(getRichmondCarService());
  }, [loading]);
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.richmondLimoService[0]._id);
    ...
    dispatch(updateRichmondCarService(formData));
  };
