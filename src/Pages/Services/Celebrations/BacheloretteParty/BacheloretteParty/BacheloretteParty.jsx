...
import {
  getBacheloretteParty,
  updateBacheloretteParty,
} from "../../../../../redux/ContentManagement/BacheloretteParty/action";
...
const BacheloretteParty = () => {
  ...
  const handleClick = (e) => {
    ...
    dispatch(updateBacheloretteParty(formData));
  };
                ...
                <div className={styles.Div2}>
                  <section className={styles.section1}>
                    ...
                    <section className={styles.inputSection}>
                      <textarea
                        type="text"
                        placeholder="The purpose of having a bachelorette party..."
