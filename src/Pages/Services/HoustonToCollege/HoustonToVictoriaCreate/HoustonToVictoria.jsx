...
import styles from "./HoustonToVictoria.module.scss";
import { Alert } from "reactstrap";
import Loader from "../../../../Components/Loader/Loader";
import { useDispatch, useSelector } from "react-redux";
import {
 getHoustonToVictoria,
  updateHoustonToVictoria,
  clearMessages,
} from "../../../../redux/ContentManagement/houstontovictoria/action";
import FormData from "form-data";

const HoustonToVictoriaCreate = () => {
  ...
  const {
    ...
    updated,
    error,
  } = useSelector((state) => state.houstonToVictoria);

  useEffect(() => {
    dispatch(getHoustonToVictoria());
  }, [loading]);
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.HoustonToVictoria[0]._id);
    ...
    dispatch(updateHoustonToVictoria(formData));
  };
...
export default HoustonToVictoriaCreate;
