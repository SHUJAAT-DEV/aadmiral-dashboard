...
import styles from "./HoustonToCollege.module.scss";
import { Alert } from "reactstrap";
import Loader from "../../../../Components/Loader/Loader";
import { useDispatch, useSelector } from "react-redux";
import {
  getHoustonToCollege,
  updateHoustonToCollege,
  clearMessages,
} from "../../../../redux/ContentManagement/houstonToCollege/action";
import FormData from "form-data";

const HoustonToCollege = () => {
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.HoustonToCollegeStation[0]._id);
    ...
    dispatch(updateHoustonToCollege(formData));
  };
...
export default HoustonToCollege;
