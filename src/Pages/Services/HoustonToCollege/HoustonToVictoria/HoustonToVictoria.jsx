...
import { getHoustonToVictoria } from "../../../../redux/ContentManagement/houstontovictoria/action";
import Loader from "../../../../Components/Loader/Loader";
import { Alert } from "reactstrap";

const HoustonToVictoria = () => {
    ...
    <div className={styles.dashboard_container}>
      <section className="app-content-wrapper">
        <div className={styles.dashboard_content_container}>
          <h2>Houston To Victoria</h2>

          {modifiedResponse ? (
            modifiedResponse.HoustonToVictoria.map((item) => (
              <Card className={styles.table_card}>
                <CardBody className={styles.table_card_body}>
                  ...
                  <div className={styles.bottomButton}>
                    <Link to="/houston-to-victoria-create">
