...
import styles from "./HoustonToLakeCharles.module.scss";
import { useDispatch, useSelector } from "react-redux";
import {
  getHoustonToLakecharles,
  updateHoustonToLakecharles,
} from "../../../../redux/ContentManagement/houstonToLakecharles/action";
import Loader from "../../../../Components/Loader/Loader";
import { Alert } from "reactstrap";

const HoustonToLakeCharles = () => {
  ...
  const {
    ...
    updated,
    error,
  } = useSelector((state) => state.houstonToLakecharles);

  useEffect(() => {
    dispatch(getHoustonToLakecharles());
  }, [loading]);
  ...
  const [wePickYouUpFrom, setWePickYouUpFrom] = useState("");
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", modifiedResponse.houstonToLakeCharles[0]._id);
    ...
    formData.append("wePickYouUpFrom", wePickYouUpFrom);
    dispatch(updateHoustonToLakecharles(formData));
  };
              ...
              <CardBody className={styles.table_card_body}>
                <div className={styles.Div1}>
                  <section className={styles.section1}>
                    ...
                    <section className={styles.inputSection}>
                      ...
                      <input
                        type="text"
                        placeholder="Houston to Lake Charles"
                        value={heroTitle}
                    ...
                    <section className={styles.inputSection}>
                      ...
                      <input
                        type="text"
                        placeholder="AAdmirals Limo Service Houston to Lake..."
                ...
                <div className={styles.Div3}>
                  ...
                  <section className={styles.inputSection}>
                    <textarea
                      type="text"
                      placeholder="Service you Trust,..."
                      value={wePickYouUpFrom}
                      onChange={(e) => setWePickYouUpFrom(e.target.value)}
                    />
                  </section>
                  {/* <h6>Description</h6>
                  <section className={styles.inputSection}>
...
export default HoustonToLakeCharles;
