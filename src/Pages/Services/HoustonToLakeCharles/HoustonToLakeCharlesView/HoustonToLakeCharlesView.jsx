...
import styles from "./HoustonToLakeCharlesView.module.scss";
import { Link } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import { getHoustonToLakecharles } from "../../../../redux/ContentManagement/houstonToLakecharles/action";
import Loader from "../../../../Components/Loader/Loader";
import { Alert } from "reactstrap";

const HoustonToLakeCharlesView = () => {
    ...
    <div className={styles.dashboard_container}>
      <section className="app-content-wrapper">
        <div className={styles.dashboard_content_container}>
          <h2>Houston</h2>
          {modifiedResponse ? (
            modifiedResponse.houstonToLakeCharles.map((item) => (
              <Card className={styles.table_card}>
                <CardBody className={styles.table_card_body}>
                  ...
                  <div className={styles.bottomButton}>
                    <Link to="/houston-to-lakecharles">
...
export default HoustonToLakeCharlesView;
