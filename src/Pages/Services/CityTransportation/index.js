...
const CityTransportation = () => {
  let [city,setCity]=useState({})
  useEffect(()=>{
axios.get(`${url}/website-content/city-to-city-transfer`).then((res)=>{
  setCity(res.data.modifiedResponse.citytoCityTransfer[0])
})
  },[])
  console.log(city)
        ...
        <div className="dashboard_content_container">
          ...
          <div>
            ...
            <div className="update_btn">
                <Link to="/city-to-city-transfer-create"> 
...
export default CityTransportation;
