...
const CelebrationCreate = () => {
 let [city,setCity]=useState(null)
  ...
  useEffect(()=>{
    axios.get(`${url}/website-content/celebrations-transfer`).then((res)=>{
     let data= res.data.modifiedResponse.celebrationsTransfer[0]
     setCity(data._id)
  ...
  const handleClick = (e) => {
   ...
   axios.post(`${url}/admin/celebrations-transfer-page`,formData).then((res)=>{
     console.log(res)
   })
