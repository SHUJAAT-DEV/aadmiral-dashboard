...
const EventsCreate = () => {
 let [city,setCity]=useState(null)
  ...
  useEffect(()=>{
    axios.get(`${url}/website-content/events-transfer`).then((res)=>{
     let data= res.data.modifiedResponse.eventsTransfer[0]
      setCity(data._id)
  ...
  const handleClick = (e) => {
   ...
   axios.post(`${url}/admin/events-transfer-page`,formData).then((res)=>{
     console.log(res)
