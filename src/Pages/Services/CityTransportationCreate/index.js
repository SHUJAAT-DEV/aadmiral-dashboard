...
const CityTransportationCreate = () => {
  ...
  useEffect(() => {
    axios.get(`${url}/website-content/city-to-city-transfer`).then((res) => {
      let data = res.data.modifiedResponse.citytoCityTransfer[0]
  ...
  const handleClick = (e) => {
    ...
    formData.append("id", "6148501349a5e53bc8e1609e");
    ...
    axios.post(`${url}/admin/city-to-city-transfer-page`, formData).then((res) => {
      console.log(res)
...
export default CityTransportationCreate;
